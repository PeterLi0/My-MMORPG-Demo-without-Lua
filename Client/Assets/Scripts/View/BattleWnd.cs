...
public class BattleWnd : BaseWnd
{
    ...
    {
        _btnReturn = _transform.FindChild("BtnReturn").GetComponent<Button>();
        _btnReturn.onClick.AddListener(OnReturnBtnClick);

        _tipsText = _transform.FindChild("TipsText").GetComponent<Text>();
    ...
    public void CreateBloodText(Character ch, int hp, BloodTextType type)
    {
        ...
        TimerManager.instance.Invoke(1.0f, () =>
        {
