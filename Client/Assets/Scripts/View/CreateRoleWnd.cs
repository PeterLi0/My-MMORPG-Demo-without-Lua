...
public class CreateRoleWnd : BaseWnd
{
    ...
    {
        _roleName = _transform.FindChild("RoleName").GetComponent<InputField>();

        Button btnReturn = _transform.FindChild("BtnReturn").GetComponent<Button>();
        btnReturn.onClick.AddListener(OnReturn);

        Button btnEnterGame = _transform.FindChild("BtnCreateRole").GetComponent<Button>();
        ...
        Dictionary<int, RoleCfg> roleCfgs = ConfigManager.instance.roleCfgs;
        currentRoleCfg = ConfigManager.instance.roleCfgs[1001];
    ...
    private void OnReturn()
    {
        ...
        NetworkManager.instance.Send((int)MsgID.ACC_OFFLINE_CREQ, req);
    }
    ...
    private void OnCreateRole()
    {
        ...
        NetworkManager.instance.Send((int)MsgID.CHAR_CREATE_CREQ, req);
    }
}