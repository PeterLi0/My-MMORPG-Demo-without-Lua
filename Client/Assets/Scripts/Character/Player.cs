...
public class Player : Character
{
    ...
    {
        Vector3 pos3 = position + new Vector3(vec.x, 0, vec.y) * 3;
        Vector pos = new Vector { x = pos3.x, y = pos3.y, z = pos3.z };
        NetworkManager.instance.Send((int)MsgID.SCENE_CharMove_CREQ, new ReqCharacterMove { pos = pos });
       // Move(pos);
    }
